...
/**
 * Book a new appointment with a doctor (FREE - no credits required)
 * Still requires the doctor to be VERIFIED
 */
export async function bookAppointment(formData) {
  ...
  try {
    ...
    // Booking still requires VERIFIED doctor
...
/**
 * Get doctor by ID
 * NOTE: Removed verificationStatus requirement so profile page does not crash
 */
  ...
  try {
    const doctor = await db.user.findUnique({
      where: {
        id: doctorId,
        role: "DOCTOR",
        // verificationStatus: "VERIFIED", // temporarily removed
      },
    });
 ...
 * NOTE: Also removed verificationStatus requirement for testing
 */
