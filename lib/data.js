...
export const creditBenefits = [
  "General Consultation / <strong class='text-emerald-400'> Treatment </strong>",
  "Diabetes <strong class='text-emerald-400'> / Hypertension Clinic</strong>",
  "Telemedicine, <strong class='text-emerald-400'> Follow up and </strong> Reviews",
  "Immunization <strong class='text-emerald-400'></strong>",
  "Paediatric <strong class='text-emerald-400'>Clinic</strong> without penalties",
  "Counselling , <strong class='text-emerald-400'>Services</strong>",
  "Nutritional, <strong class='text-emerald-400'> Services </strong> Reviews",
  "Family <strong class='text-emerald-400'> Planning </strong>",
  "PNC <strong class='text-emerald-400'>(Postnatal Care)</strong>",
  "ANC <strong class='text-emerald-400'>(Antenatal Care)</strong>",
  "MCH <strong class='text-emerald-400'>(Maternal & Child Health)</strong>",
];
