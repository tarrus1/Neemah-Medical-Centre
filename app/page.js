      ...
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="flex items-center justify-center gap-3 text-3xl md:text-4xl font-bold tracking-wide text-white mb-4">
              <Stethoscope className="h-8 w-8 md:h-10 md:w-10 text-emerald-400 shrink-0" />
    ...
    <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-5">
      {creditBenefits.map((benefit, index) => (
        <li key={index} className="flex items-start">
          <div className="mr-4 mt-1 bg-emerald-900/20 p-1.5 rounded-full shrink-0">
            <svg
            ...
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div className="max-w-2xl relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    <Link href="/doctors">View Services</Link>
                  </Button>
                </div>
              </div>
